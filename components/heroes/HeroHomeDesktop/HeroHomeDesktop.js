  ...
  return (
    <>
      <div className='relative hidden md:block'>
        ...
        <div className='absolute inset-0 w-3/5 h-176 lg:h-screen bg-gradient-to-r from-white opacity-80'></div>
        <div className='absolute bottom-0 w-screen h-1/3 bg-gradient-to-t from-white'></div>

        <div className='absolute bottom-0 left-0 w-1/2 mb-8 ml-8 space-y-8 lg:mb-16 xl:ml-20 lg:w-2/5 lg:space-y-10'>
          {/* TEXT */}
